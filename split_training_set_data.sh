...
head -n $training_amount ./training_set_data/matrices.txt > ./training_set_data/matrices_train.txt
head -n $training_amount ./training_set_data/labels.txt > ./training_set_data/labels_train.txt
tail -n $test_amount ./training_set_data/matrices.txt > ./training_set_data/matrices_test.txt
